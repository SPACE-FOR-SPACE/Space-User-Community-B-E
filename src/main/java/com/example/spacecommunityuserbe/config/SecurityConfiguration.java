    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((request) -> request
                        ...
                        .requestMatchers(HttpMethod.GET, "/community/doc/{user}").permitAll()
                        .requestMatchers(HttpMethod.POST, "/community/doc").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/community/doc/**").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/community/doc/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/community/doc/**").permitAll()
