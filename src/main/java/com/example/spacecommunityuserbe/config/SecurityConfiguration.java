    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((request) -> request
                        ...
                        .requestMatchers(HttpMethod.POST, "/community/document").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/community/documents/**").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/community/documents/**").permitAll()
